...
# Define target column and non-feature columns
...
# Initialize and configure the Random Forest Regressor
...
# Highlight important features to reduce over-reliance
top_features = importance_df[importance_df["Importance"] > 0.05]["Feature"].tolist()
...
import joblib
joblib.dump(rf_model, "aircraft_rating_model.pkl")
print("Model has been saved as 'aircraft_rating_model.pkl'")